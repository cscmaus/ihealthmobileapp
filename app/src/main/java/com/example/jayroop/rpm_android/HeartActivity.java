...
public class HeartActivity extends AppCompatActivity implements OnDataPointListener,
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        ...
        if( !authInProgress ) {
            try {
                authInProgress = true;
                connectionResult.startResolutionForResult( HeartActivity.this, REQUEST_OAUTH );
